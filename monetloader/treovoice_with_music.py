...
class AudioMixer:
    ...
    def load_music(self, file_path):
        ...
        try:
            ...
            print(f"{Fore.LIGHTGREEN_EX}✓ Load nhạc: {os.path.basename(file_path)}{Style.RESET_ALL}")
            return True
...
def main():
    ...
    print(f"║  {Fore.LIGHTMAGENTA_EX}Discord Voice Bot v6 (+ MUSIC MIX){Fore.LIGHTCYAN_EX}}         ║")
    print(f"║  {Fore.LIGHTGREEN_EX}Gateway v10 + Voice v9 + Live + Music{Fore.LIGHTCYAN_EX}    ║")
    ...
    print(f"║  {Fore.LIGHTGREEN_EX}[8]{Fore.LIGHTCYAN_EX} Load nhạc  {Fore.LIGHTGREEN_EX}[9]{Fore.LIGHTCYAN_EX} Bật/Tắt nhạc   ║")
    print(f"║  {Fore.LIGHTGREEN_EX}[10]{Fore.LIGHTCYAN_EX} Chỉnh volume nhạc                      ║")
    print(f"╚════════════════════════════════════════════╝{Style.RESET_ALL}\n")
        ...
        while bot.running:
            try:
                ...
                if cmd == "1":
                    ...
                    # Load nhạc
                    music_file = input(f"{Fore.CYAN}Nhập đường dẫn file nhạc (mp3/wav): {Style.RESET_ALL}").strip()
                    if os.path.exists(music_file):
                        bot.mixer.load_music(music_file)
                    else:
                    ...
                    # Chỉnh volume
                    try:
                        vol = float(input(f"{Fore.CYAN}Volume nhạc (0.0-1.0): {Style.RESET_ALL}"))
